...
void default_colour( CHAR_DATA *ch )
{
    ...
    ch->pcdata->auction[1]	= ( WHITE );
    ch->pcdata->auction_text[1]	= ( CYAN );
    ch->pcdata->gossip[1]	= ( WHITE );
    ch->pcdata->gossip_text[1]	= ( BLUE );
    ...
    ch->pcdata->immtalk_text[1]	= ( RED );
    ch->pcdata->immtalk_type[1]	= ( WHITE );
    ch->pcdata->info[1]		= ( YELLOW );
    ch->pcdata->tell[1]		= ( WHITE );
    ch->pcdata->tell_text[1]	= ( GREEN );
    ch->pcdata->say[1]		= ( WHITE );
    ch->pcdata->say_text[1]	= ( YELLOW );
