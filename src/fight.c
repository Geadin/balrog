...
void dam_message( CHAR_DATA *ch, CHAR_DATA *victim,int dam,int dt,bool immune )
{
	...
	return;
	 ...
	 if ( dam ==   0 ) { vs = "\e[0;36mmiss{x";	vp = "\e[0;36mmisses{x";		}
    else if ( dam <=   4 ) { vs = "{1scratch{x";	vp = "{1scratches{x";	}
    else if ( dam <=   8 ) { vs = "{1graze{x";	vp = "{1grazes{x";		}
    else if ( dam <=  12 ) { vs = "{1hit{x";	vp = "{1hits{x";		}
    else if ( dam <=  16 ) { vs = "{1injure{x";	vp = "{1injures{x";		}
    else if ( dam <=  20 ) { vs = "{1wound{x";	vp = "{1wounds{x";		}
    else if ( dam <=  24 ) { vs = "{1maul{x";       vp = "{1mauls{x";		}
    else if ( dam <=  28 ) { vs = "{1decimate{x";	vp = "{1decimates{x";	}
    else if ( dam <=  32 ) { vs = "{1devastate{x";	vp = "{1devastates{x";	}
    else if ( dam <=  36 ) { vs = "{1maim{x";	vp = "{1maims{x";		}
    else if ( dam <=  40 ) { vs = "{1MUTILATE{x";	vp = "{1MUTILATES{x";	}
    else if ( dam <=  44 ) { vs = "{1DISEMBOWEL{x";	vp = "{1DISEMBOWELS{x";	}
    else if ( dam <=  48 ) { vs = "{1DISMEMBER{x";	vp = "{1DISMEMBERS{x";	}
    else if ( dam <=  52 ) { vs = "{1MASSACRE{x";	vp = "{1MASSACRES{x";	}
    else if ( dam <=  56 ) { vs = "{1MANGLE{x";	vp = "{1MANGLES{x";		}
    else if ( dam <=  60 ) { vs = "{1*** DEMOLISH ***{x";
			     vp = "{1*** DEMOLISHES ***{x";			}
    else if ( dam <=  75 ) { vs = "{1*** DEVASTATE ***{x";
			     vp = "{1*** DEVASTATES ***{x";			}
    else if ( dam <= 100)  { vs = "{1=== OBLITERATE ==={x";
			     vp = "{1=== OBLITERATES ==={x";		}
    else if ( dam <= 125)  { vs = "{1>>> ANNIHILATE <<<{x";
			     vp = "{1>>> ANNIHILATES <<<{x";		}
    else if ( dam <= 150)  { vs = "{1<<< ERADICATE >>>{x";
			     vp = "{1<<< ERADICATES >>>{x";			}
    else                   { vs = "{1do UNSPEAKABLE things to{x";
			     vp = "{1does UNSPEAKABLE things to{x";		}
...
void do_dirt( CHAR_DATA *ch, char *argument )
{
	...
	act("{5$n kicks dirt in your eyes!{x",ch,NULL,victim,TO_VICT);
        damage(ch,victim,number_range(2,8),gsn_dirt,DAM_NONE,TRUE); //changed number_range and FALSE to TRUE
